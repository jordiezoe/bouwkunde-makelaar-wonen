      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <span className="text-2xl shrink-0">📖</span>
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-sm leading-tight">Leeslijst</div>
              <div className="text-sky-100 text-xs mt-0.5">
                welke samenvatting-hoofdstukken je moet lezen · afvinken
              </div>
            </div>
            <span className="text-sky-100 shrink-0">→</span>
          </button>
          <button
