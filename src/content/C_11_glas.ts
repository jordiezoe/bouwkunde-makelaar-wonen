...
- **Helpt energie­label** (1–2 stappen verhoging mogelijk)
  ...
  questions: [
    // C.11.1 (5)
    {
      ...
      options: [
        'Hoogrendementglas met Low-E-coating en argon in de spouw',
        'Handreinigend zelfreinigend glas',
        'Hard-gehard veiligheidsglas',
        'Een soort kunststof plaat',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Asymmetrisch dubbel glas met een gelaagde ruit',
        'Drie glasplaten zonder spouw',
        'Een dikkere coating aan te brengen',
        'Het glas te harden',
      ],
      correctIndex: 0,
      explanation:
    ...
    // C.11.4 (3)
    {
      ...
      options: [
        'Glas rechtstreeks op het frame gelijmd met siliconenkit',
        'Een tweede beglazing voor extra isolatie',
        'Glas met staal­wapening erin',
        'Glasvezelversterkt glas',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Glas op punten bevestigd met RVS-spiders in boorgaten',
        'Glas met stalen netten erin',
        'Klassiek glas-in-lood',
        'Glas met een spinnenweb-patroon',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Twee gevels met een geventileerde bufferspouw ertussen',
        'Een gevel in twee verschillende kleuren',
        'Een gevel met klimaatregelapparatuur',
        'Een gevel met ingebouwde airco',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Veroudering van de randafdichting rond de afstand­houder',
        'Slechte ventilatie in de woning',
        'Een te hoge buitentemperatuur',
        'UV-licht dat door het glas valt',
      ],
      correctIndex: 0,
      explanation:
