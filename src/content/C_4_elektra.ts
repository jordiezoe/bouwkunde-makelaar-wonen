...
- **BTW-vrijgesteld**: bij oplevering geen overdracht van BTW; bewijs van afsluiting BTW-vrijstelling kan informatie­plicht zijn
  ...
  questions: [
    ...
    // C.4.2 (5)
    {
      ...
      options: [
        'Bruin = fase, blauw = nul, groen/geel = aarde',
        'Blauw = fase, bruin = nul, rood = aarde',
        'Rood = fase, zwart = nul, groen = aarde',
        'Zwart = fase, wit = nul, geel = aarde',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een cirkel met S2 (tweewegsymbool)',
        'Een cirkel met een enkele streep',
        'Een cirkel met de letter R',
        'Een driehoek',
      ],
      correctIndex: 0,
      explanation:
