...
- **Documentatie** is essentieel voor latere claims
  ...
  questions: [
    // D.2.1 (5)
    {
      ...
      options: [
        'Visueel beoordelen en een druk-test met een priem',
        'Alleen de kleur van het hout beoordelen',
        'De verflaag met een vochtmeter doormeten',
        'Het kozijn op gewicht controleren',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een verticale scheur > 2 mm door meerdere lagen',
        'Een haarscheur < 1 mm in het voegwerk',
        'Een lichte verkleuring van de voegen',
        'Fijne krimpscheurtjes in het pleisterwerk',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Blaasvorming en scheuren langs de randen',
        'Een strak liggende, egale toplaag',
        'Een recent aangebrachte kiezellaag',
        'Een pas vervangen hemelwaterafvoer',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Klop-test: een hol geluid betekent loszittend werk',
        'Alleen visueel inspecteren',
        'Er lijm achter injecteren',
        'Met een vochtmeter doormeten',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Constructie- en vochtveiligheid',
        'De cosmetische uitstraling',
        'De energiezuinigheid',
        'De kleurstelling van de gevel',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.2.2 (5)
    {
      ...
      options: [
        'Fors verbeterbaar: isolatie, HR++-glas en warmtepomp → richting label A',
        'Geen actie nodig, de woning is in goede staat',
        'Alleen de zolder isoleren volstaat',
        'Uitsluitend de ventilatie hoeft verbeterd',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Vergunningplicht en behoud van uitstraling; isolatie via monumentenglas',
        'Er gelden geen beperkingen op de renovatie',
        'Het pand mag niet meer bewoond worden',
        'Alleen inpandige werken zijn vrij toegestaan',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Bestemmingsplan, asbest, constructie, installaties en daglicht',
        'Uitsluitend het vloeroppervlak',
        'Alleen de kleur van de gevel',
        'Geen controle nodig, direct verbouwen',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Houten palen rotten door een gedaalde grondwaterstand',
        'De palen zijn te diep geheid',
        'Het bouwjaar is te recent voor houten palen',
        'Betonpalen corroderen door zeewater',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Bereikbaarheid, voorzieningen, geluid en wateroverlast­risico',
        'Uitsluitend de huidige populariteit',
