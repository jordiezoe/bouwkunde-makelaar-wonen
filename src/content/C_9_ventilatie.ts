...
- **Energie-label**: een recirculatie-kap met WTW-systeem werkt meestal als hetzelfde label-niveau (geen extra impact)
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        'Aanvoer via kozijnroosters, afvoer via passieve kanalen',
        'Een centrale ventilator zuigt de lucht aan',
        'Straatlucht wordt gefilterd aangevoerd',
        'Een WTW verwarmt de aankomende lucht',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Roosters voor aanvoer, een centrale ventilator zuigt af',
        'Twee losse ventilatoren in keuken en badkamer',
        'Een centrale WTW met dubbele ventilator',
        'Uitsluitend ramen openzetten',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een centrale unit die ventileert, verwarmt, koelt en filtert',
        'Een type rookmelder',
        'Een houtgestookte kachel',
        'Een dak­ventilator',
      ],
      correctIndex: 0,
      explanation:
    ...
    // C.9.2 (2)
    {
      ...
      options: [
        'Een centrale unit met warmtewisselaar, filter en twee kanalen in balans',
        'Ventilatieroosters in alle kozijnen',
        'Alleen afzuig­ventielen in de keuken',
    ...
    },
    {
      ...
      options: [
        'Over- of onderdruk: tocht, condens en minder WTW-rendement',
        'Geen merkbare effecten',
        'Een hogere luchttemperatuur',
        'De filters verstoppen sneller',
      ],
      correctIndex: 0,
      explanation:
    ...
    // C.9.3 (2)
    {
      ...
      options: [
        'Gemeenschappelijke verticale afvoerkanalen in een flatgebouw',
        'Moderne WTW-toevoerkanalen',
        'Brandweer-blusleidingen',
        'Toevoerkanalen voor schone lucht',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Geen luchtvermenging met buren en een eigen WTW mogelijk',
        'Lagere installatiekosten',
        'Het vergt geen onderhoud',
    ...
    // C.9.4 (3)
    {
      ...
      options: [
        'In verblijfsruimten: woon-, slaap- en werkkamer',
    ...
    },
    {
      ...
      options: [
        'Vaak recirculatie, of afzuig-naar-buiten met balanscompensatie',
        'Altijd rechtstreeks afzuigen naar buiten',
        'Er is geen afzuigkap nodig',
        'Alleen een raam openzetten tijdens koken',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Elke 1–2 maanden; vet in het filter is brandgevaarlijk',
        'Nooit — vet verdampt vanzelf',
        'Eenmaal per tien jaar',
        'Alleen bij zichtbare vervuiling',
      ],
      correctIndex: 0,
      explanation:
