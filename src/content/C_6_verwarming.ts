...
- **Niet over uitzettingsvoegen** leggen — slang scheurt bij beweging
  ...
  questions: [
    // C.6.1 (2)
    {
      ...
      options: [
        'Lokaal = één toestel per ruimte; decentraal = per zone/appartement',
        'Lokaal = per zone; decentraal = één toestel per ruimte',
    ...
    },
    {
      ...
      options: [
        'Grotere radiatoren of vloerverwarming, plus goed isoleren',
        'Niets aanpassen aan de warmteafgifte',
        'Alleen de cv-ketel vervangen',
        'Extra ventilatie aanbrengen',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een convector heeft lamellen voor extra convectie',
        'Ze zijn identiek',
        'Een convector is altijd groter',
        'Een convector werkt elektrisch, een radiator op water',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een radiator uit losse gietijzeren of stalen elementen',
        'Een modern paneel met vlakke platen',
    ...
    // C.6.4 (2)
    {
      ...
      options: [
        'Aanvoer in rood, retour in blauw',
        'Beide in dezelfde kleur',
        'Alleen met tekst, zonder kleur',
        'Beide als streep-stippellijn',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Het verwarmt direct het lichaam; de lucht hoeft niet warm',
        'Stralings­warmte is altijd warmer',
        'Convectiewarmte vraagt meer elektriciteit',
        'Het verwarmt de ruimte veel sneller',
      ],
      correctIndex: 0,
      explanation:
    ...
    // C.6.6 (2)
    {
      ...
      options: [
        'Snelle opwarming en combineerbaar met ventilatie',
        'Structureel lagere energiekosten',
        'Er zijn geen apparaten voor nodig',
        'Het werkt zonder elektriciteit',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'COP = 1; een warmtepomp levert er 3–4× zo veel warmte uit',
        'Het verwarmt eenvoudigweg niet goed',
        'Het is brandgevaarlijk',
        'Er is te weinig stroom beschikbaar in NL',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een HRe wekt naast warmte ook stroom op (micro-WKK)',
        'Een HRe is simpelweg een goedkopere HR-ketel',
    ...
    // C.6.8 (4)
    {
      ...
      options: [
        'Een bodemwarmtepomp met brine in de gesloten bronlus',
        'Een warmtepomp die op zout zeewater werkt',
        'Een warmtepomp met fosforzuur als koudemiddel',
        'Een warmtepomp die grondwater oppompt',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Als bijverwarming in een badkamer of kleine renovatieruimte',
        'Altijd — het is de moderne standaard',
        'Als hoofdverwarming voor een hele all-electric woning',
        'Alleen in combinatie met een cv-ketel',
      ],
      correctIndex: 0,
      explanation:
