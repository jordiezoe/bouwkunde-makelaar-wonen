  ...
  questions: [
    {
      ...
      options: [
        'Verwarmen, koelen, ontvochtigen, filteren en ventileren',
        'Alleen koelen',
        'Alleen ventileren',
        'Alleen filteren',
      ],
    ...
    },
    {
      ...
      options: [
        'Een centrale unit voor verwarmen, koelen, filteren en ventileren',
    ...
    },
    {
      ...
      options: [
        'Een centrale luchtbehandelingskast met luchtkanalen',
        'Mono-split airco per kamer',
    ...
    },
    {
      ...
      options: [
        'Verwarmde winterlucht is te droog; bevochtigen tot 40–60 %',
