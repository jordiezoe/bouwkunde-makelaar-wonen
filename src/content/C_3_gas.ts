...
- **Waterstof in bestaande gasleidingen**: experimenteel (Stad aan't Haringvliet, Hoogeveen) — toekomstige optie voor moeilijk te isoleren panden
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        'Een mantelbuis',
        'Een brandwerende coating',
        'Een isolatieschil',
        'Een geluidsdempingslaag',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Dienstleiding → meter → stijgleiding → afsluitkraan → toestel',
        'Toestel → afsluitkraan → meter → dienstleiding → hoofdleiding',
        'Meter → centrale verdeler in de cv-ruimte → elk toestel',
        'Hoofdleiding → toestel, zonder meter of afsluitkraan',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Verzwaren naar 3×25 A (driefasen)',
        'De bestaande 1×25 A blijft voldoende',
        'Terug naar 1×20 A volstaat',
        'Een aparte 12 V-lichtkrachtgroep',
      ],
      correctIndex: 0,
      explanation:
