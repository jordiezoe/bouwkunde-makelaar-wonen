  ...
  questions: [
    // D.1.1 (3)
    {
      ...
      options: [
        ...
        'Meerjaren­investerings­prognose',
        'Bouwkundig opnamerapport',
        'Onderhouds­abonnement van de VvE',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Norm voor conditiemeting van gebouwen',
        'Norm voor de energieprestatie van gebouwen',
        'Norm voor brandwerendheid van constructies',
        'Norm voor geluidsisolatie tussen woningen',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Min. 0,5 % van de herbouwwaarde (of het MJOP-bedrag)',
        'Min. 0,5 % van de WOZ-waarde',
        'Min. 1 % van de herbouwwaarde',
        'Een door de ALV vrij te bepalen bedrag',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.1.2 (2)
    {
      ...
      options: [
        'Conditiescore, gebrek, aanbevolen actie, jaar en kosten',
        'Alleen de conditiescore volgens NEN 2767',
        'De actuele markt- en verkoopwaarde',
        'De aannemer en de garantietermijn',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'Elk jaar',
        'Elke 10 jaar',
        'Alleen bij verkoop van een appartement',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.1.3 (3)
    {
      ...
      options: [
        'Renovatie moderniseert; restauratie herstelt de oorspronkelijke staat',
        'Renovatie herstelt de oorspronkelijke staat; restauratie moderniseert',
        'Renovatie is voor woningen, restauratie alleen voor monumenten',
        'Ze verschillen alleen in de kosten',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Herontwikkeling wijzigt de functie; renovatie behoudt die',
        'Herontwikkeling behoudt de functie; renovatie wijzigt die',
        'Herontwikkeling is altijd sloop met nieuwbouw',
        'Herontwikkeling geldt alleen voor hele wijken',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Herontwikkeling = per gebouw; transformatie = gebieds­breed',
        'Herontwikkeling = gebieds­breed; transformatie = per gebouw',
        'Transformatie betekent altijd sloop',
    ...
    // D.1.4 (4)
    {
      ...
      options: [
        'Vooraf gepland, preventief onderhoud volgens MJOP',
        'Onderhoud dat je pas na een klacht uitvoert',
        'Onderhoud bij wisseling van huurder',
        'Onderhoud dat is uitgesteld tot later',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Onderhoud dat had gemoeten, maar is uitgesteld',
        'Onderhoud dat te vroeg is uitgevoerd',
        'Vooraf gepland, preventief onderhoud',
        'Onderhoud bij een huurderswisseling',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Onderhoud bij wisseling van huurder',
        'Onderhoud aan gewijzigde installaties',
        'Preventief onderhoud volgens de planning',
        'Onderhoud aan bewegende delen',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Slopen van een gebouw of onderdeel',
        'Een gebouw verplaatsen',
        'Renoveren met behoud van de gevel',
        'Een gebouw aan de woningvoorraad onttrekken',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.1.5 (3)
    {
      ...
      options: [
        'Constructieve, vocht-, brand- en installatie­veiligheid',
        'Verouderd schilderwerk en de kleurstelling',
        'Een gedateerde keuken en badkamer',
        'De energielabel-klasse van de woning',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Bouwjaar, materiaal, omgeving, eerder onderhoud en gebruik',
        'Uitsluitend de leeftijd van het pand',
        'Uitsluitend de vraagprijs',
        'Uitsluitend het woonoppervlak',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'Opnemen in het planmatig onderhoud (binnen 5 jaar)',
        'Monitoren, nog geen actie nodig',
        'Onmiddellijk ontruimen wegens levensgevaar',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.1.6 (3)
    {
      ...
      options: [
        'Technisch = tot het faalt; economisch = tot vervangen lonender is',
        'Technisch = tot vervangen lonender is; economisch = tot het faalt',
        'De economische levensduur is altijd langer',
    ...
    },
    {
      ...
      options: [
        'Periode dat een element functioneert, mits regulier onderhouden',
        'De wettelijke garantietermijn na oplevering',
        'De levensduur zónder enig onderhoud',
        'De fiscale afschrijvingstermijn',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Zoutmist en hogere vochtigheid tasten hout en verf sneller aan',
        'Aan de kust wordt structureel minder onderhouden',
        'Aan de kust is de UV-straling veel hoger',
        'Zeewind koelt het hout af, waardoor het krimpt',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.1.7 (3)
    {
      ...
      options: [
        'Volledig elke 5–7 jaar, plaatselijk bijwerken elke 2–3 jaar',
        'Volledig elke 15 jaar',
        'Alleen eenmalig bij de oplevering',
        'Elk jaar volledig overschilderen',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Jaarlijkse inspectie en hemelwater­afvoeren schoonhouden',
        'De dakpannen periodiek schilderen',
        'Het dak jaarlijks met een hogedrukreiniger reinigen',
        'De dakbedekking elke 10 jaar vervangen',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Voegwerk elke 25–50 jaar; hydrofoberen elke 10–15 jaar',
        'Voegwerk jaarlijks bijwerken',
        'Voegen hebben nooit onderhoud nodig',
        'Voegwerk elke 5 jaar volledig uithakken',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.1.8 (2)
    {
      ...
      options: [
        ...
        'De oorspronkelijke aanschafprijs',
        'De marktwaarde van de woning',
        'De grootte van het bouwdeel',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Grotere weersbelasting op dak en aansluitingen',
        'Meer loopgeluid van bovengelegen woningen',
        'Hogere kans op optrekkend grondvocht',
        'Zwaardere belasting van de fundering',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.1.9 (4)
    {
      ...
      options: [
        'Een constructeur raadplegen; buitenmuren zijn vrijwel altijd dragend',
        'Aan het materiaal: beton draagt, gips nooit',
        'Aan de kleur van het stucwerk',
        'Dragende wanden staan altijd haaks op de gevel',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Constructeur berekent een vervangingsligger; vergunning; erkend bedrijf',
        'Direct slopen en achteraf een stalen ligger plaatsen',
        'Zelf slopen zonder vergunning bij lage panden',
        'Alleen de bovenliggende vloer stutten tijdens de sloop',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Vergunning­check, nieuwe fundering en gevelaansluiting',
        'Alleen toestemming van de directe buren',
        'Uitsluitend een melding bij de gemeente',
        'Alleen een aanpassing van de hypotheek',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Mechanische afzuiging van minimaal 14 l/s (≈ 50 m³/h)',
        'Mechanische afzuiging van minimaal 7 l/s (≈ 25 m³/h)',
        'Een te openen raam volstaat',
        'Mechanische afzuiging van minimaal 100 l/s',
      ],
      correctIndex: 0,
      explanation:
