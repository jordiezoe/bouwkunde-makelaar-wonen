...
- **Bestemmingsplan-wijziging** (kantoor naar woning): kan zwaardere eisen opleveren
  ...
  questions: [
    // C.8.1 (4)
    {
      ...
      options: [
        'Een oplopend akoestisch ontruimingssignaal',
        'Een type sprinklerkop',
        'Een snelwerkende rookmelder',
        'Een waterpomp voor de brandweer',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een lege leiding waarop de brandweer per verdieping aansluit',
        'Een leeggehaalde waterleiding tijdens reparatie',
        'Een natte brandslang voor de brandweer',
    ...
    },
    {
      ...
      options: [
        'Sleutelopslag die de brandweer met een universele sleutel opent',
        'Een decoratief gevelelement',
        'Extra inbraakbeveiliging van de voordeur',
        'Een afhaalpunt voor de postbode',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Brandend frituurvet — vetblusser of blusdeken, geen water',
        'Vaste stoffen — een waterblusser',
        'Vlam­branden — een sprinkler',
    ...
    },
    {
      ...
      options: [
        'Alleen de sprinklers boven de brand, door smeltende fittingen',
        'Alle sprinklers in het hele gebouw tegelijk',
        'Geen enkele, tot de brandweer arriveert',
        'Precies één sprinkler per ruimte',
      ],
      correctIndex: 0,
      explanation:
    ...
    // C.8.3 (3)
    {
      ...
      options: [
        'Rookdeeltjes verstrooien LED-licht naar een fotosensor',
        'Een radioactief bronnetje ioniseert de lucht',
        'Een hittegevoelige thermistor',
        'Een chemische cel die CO meet',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Ze bevatten radioactief americium en missen smeulbranden vaker',
        'Ze werken helemaal niet meer',
        'Ze zijn simpelweg te duur',
        'Ze geven juist te veel vals alarm',
      ],
      correctIndex: 0,
      explanation:
    ...
    // C.8.4 (3)
    {
      ...
      options: [
        'Detectorsignalen verzamelen en alarm, doormelding en maatregelen aansturen',
        'Alleen rookmelders met een luid signaal',
        'Een sprinklerpomp',
    ...
    },
    {
      ...
      options: [
        'Een rookmelder per verdieping en bij elk slaapvertrek',
        'Een volledige Klasse A brandmeld­installatie',
        'Een sprinklerinstallatie',
        'Er geldt geen verplichting',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        '30 m in verblijfsgebied (tot twee routes max. 75 m)',
        'Maximaal 5 m',
        'Maximaal 200 m',
        'Onbeperkt',
      ],
