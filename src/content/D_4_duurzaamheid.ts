...
- **Lokale klimaat­visie** van gemeente raadplegen voor specifieke wijk-info
  ...
  questions: [
    // D.4.1 (2)
    {
      ...
      options: [
        'Bouwen met minimale milieubelasting over de levenscyclus',
        'Zo snel en goedkoop mogelijk bouwen',
        'Uitsluitend met hout bouwen',
    ...
    },
    {
      ...
      options: [
        'Beperk de vraag, gebruik hernieuwbaar, dan pas fossiel efficiënt',
        'Een warmtepomp met drie compressoren',
        'Een Bbl-eis voor drie isolatielagen',
        'Een driedubbel isolatiemateriaal',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Letter, energie-index, CO₂-indicator en verbeteradvies',
        'Alleen de letter (A–G)',
        'De koop- of huurprijs',
    ...
    // D.4.3 (3)
    {
      ...
      options: [
        'Een lucht-water-warmtepomp met warmwater­boiler',
        'Een airconditioning­systeem',
        'Een balansventilatie met WTW',
    ...
    },
    {
      ...
      options: [
        'Dikker dan enkel glas, met een coating die bij belichten oplicht',
        'Aan de groenige kleur van het glas',
        'Aan een verplichte sticker op elke ruit',
        'HR++ glas is niet te herkennen',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Een centrale unit met plafondventielen, geen kozijnroosters',
        'Ventilatieroosters in alle kozijnen',
        'Een grote ventilator aan de buitengevel',
    ...
    // D.4.4 (2)
    {
      ...
      options: [
        'Luchtdichte schil zonder ventilatie → hoge CO₂/RV en schimmel',
        'De woning wordt structureel te warm',
        'Een zwaardere belasting van de fundering',
        'Er is geen bouwfysisch risico',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'Alleen relevant bij commercieel vastgoed',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.4.5 (2)
    {
      ...
      options: [
        'Bouwen waarbij materialen in de kringloop blijven',
        'Bouwen in een ronde vorm',
        'Bouwen rond een centrale binnenplaats',
        'Werken met een roulerend bouwteam',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.4.6 (2)
    {
      ...
      options: [
        'Hernieuwbaar, recyclebaar, lang meegaand en gezond',
        'Zo goedkoop mogelijk',
        'Een glanzend, modern uiterlijk',
        'Bij voorkeur ver weg geproduceerd',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Beleggers eisen het; het bepaalt klimaat- en toekomstrisico',
        'Het is uitsluitend bedoeld voor reclame',
        'Het verandert de architectuur­stijl',
        'Het is slechts een filosofisch concept',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.4.8 (2)
    {
      ...
      options: [
        'Extreme isolatie en luchtdichtheid; nauwelijks actieve verwarming nodig',
        'Een huis zonder bewoners',
        'Een traditioneel gebouwd huis',
        'Een huis dat alleen op zonne-energie draait',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.4.9 (2)
    {
      ...
      options: [
        'Via een gekwalificeerd energieadviseur die het bij RVO registreert',
        'Het wordt door de gemeente toegekend',
        'Zelf online via een vragenlijst',
        'Via de hypotheekverstrekker',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Het is verplicht; ontbreken kan een boete opleveren',
        'Er zijn geen consequenties',
        'De woning mag nooit meer verkocht worden',
        'Een verplichte verbouwing volgt',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Verbod op kantoorgebruik en een boete tot € 25.000',
        'Geen enkel gevolg',
        'Alleen een hogere onroerendezaakbelasting',
        'Een gratis renovatie door de overheid',
      ],
      correctIndex: 0,
      explanation:
    ...
    // D.4.11 (3)
    {
      ...
      options: [
        '55 % CO₂-reductie in 2030 en klimaatneutraal in 2050',
        '20 % CO₂-reductie tegen 2050',
        'Zonnepanelen verplicht op elk dak',
        'Er zijn geen concrete doelen gesteld',
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Hybride warmtepompen, warmtenetten en verduurzaming naar label A',
        'Alle bestaande gebouwen slopen',
        'Alleen nieuwbouw verduurzamen',
        'Terugkeer naar verwarming op steenkool',
      ],
      correctIndex: 0,
      explanation:
