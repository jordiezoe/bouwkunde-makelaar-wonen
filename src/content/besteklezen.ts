...
**Wat gaat vóór bij tegenstrijdigheid?** Bestek en tekening worden geacht samen het hele werk te omvatten en moeten in samenhang worden gelezen. Als op de tekening werk staat dat niet in het bestek is genoemd (of omgekeerd), moet de aannemer het tóch uitvoeren alsof het wél is voorgeschreven. Wijkt de **beschrijving in het bestek** af van wat op de **tekening** staat, dan moet de aannemer dit vóór de aanbesteding met de directie afstemmen. De vuistregel: **de tekst van het bestek prevaleert**, tenzij het bestek zelf anders bepaalt.
  ...
  questions: [
    ...
    },
    {
      ...
      attachments: [BESTEK],
      options: [
        '3 maanden bouwkundig, 12 maanden installaties',
        '12 maanden voor alle werken',
        '6 maanden bouwkundig, 6 maanden installaties',
    ...
    },
    {
      ...
      options: [
        'Toch uitvoeren; bestek en tekening omvatten samen het werk',
        'Weglaten, want het bestek noemt de dakkapel niet',
        'Zelf beslissen of de dakkapel nuttig is',
        'Pas na oplevering plaatsen, als meerwerk',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        'De Uniforme Administratieve Voorwaarden',
...
- Maten op de tekening staan in **millimeters**. Meet nooit met een liniaal op een verkleinde print — gebruik altijd de aangegeven maatvoering.
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        'Een aansluiting exact tonen (materialen en opbouw)',
  ...
  questions: [
    {
      ...
      options: [
        'Het nulpunt van de hoogtemaatvoering',
        'De hoogte van de nok van het dak',
        'Het laagste punt van de fundering',
        'De gemiddelde hoogte van het maaiveld',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        'Het ordenen van de hoofddraagconstructie',
  ...
  questions: [
    {
      ...
      options: [
        'Een overzichtslijst van alle kozijnen met hun specificaties',
        'De verticale stijl van één kozijn',
        'De vergunning voor het plaatsen van kozijnen',
        'Het bestekhoofdstuk over schilderwerk',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        'In de kozijnstaat de specificaties van A02 opzoeken',
...
Open de bijlagen hieronder en oefen met de vragen.
  ...
  questions: [
    ...
    },
    {
      ...
      attachments: [TEK_A3],
      options: [
        'Om in de kozijnstaat de specificaties van dat kozijn op te zoeken',
  ...
  questions: [
    {
      ...
      options: [
        'De administratieve bepalingen (hoofdstuk 00)',
    ...
    },
    {
      ...
      options: [
        'Plattegrond → kozijnstaat → bestekhoofdstuk 30',
    ...
    },
    {
      ...
      options: [
        'Doorgaans prevaleert de bestektekst; overleg bij twijfel',
        'De tekening gaat altijd vóór het bestek',
        'De aannemer kiest zelf de goedkoopste optie',
        'Het werk wacht tot na oplevering',
      ],
      correctIndex: 0,
